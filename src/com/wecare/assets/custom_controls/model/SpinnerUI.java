...
public class SpinnerUI extends BasicSpinnerUI {
    ...
    public class Editor extends CustomeTextField2 implements ChangeListener {
        ...
        public void stateChanged(ChangeEvent ce) {
            ...
            setText(spinner.getValue().toString(), setDecimals, decimal_places);
        }
    }
    ...
    public void setSetDecimals(boolean setDecimals) {
        this.setDecimals = setDecimals;
    }
