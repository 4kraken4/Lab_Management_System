...
public class TableCell_Status extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        status = new com.wecare.assets.custom_controls.model.LabelStatus();

        setMaximumSize(new java.awt.Dimension(110, 40));
        setLayout(new java.awt.GridBagLayout());

        status.setText("Status");
        status.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        status.setPreferredSize(new java.awt.Dimension(85, 20));
    ...
    private com.wecare.assets.custom_controls.model.LabelStatus status;
